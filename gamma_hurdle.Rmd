...
where the conditional distribution $f(y | y > 0) \sim Gamma(k, \theta_i)$.
...
where $\mu_i = E(Y_i \:| \: Y_i > 0) = k\theta_i$. In this gamma GLM model, I'm using the log link function (instead of the canonical link of reciprocal) and assuming the same set of predictors $\boldsymbol{X_i}$ as those used in the logistic model, for the sake of simplicity.
